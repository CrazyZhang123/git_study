...
**.gitignore文件的使用方法** 首先，在你的工作区新建一个名称为.gitignore的文件。 然后，把要忽略的文件名填进去，Git就会自动忽略这些文件。不需要从头写.gitignore文件，[GitHub](https://zhida.zhihu.com/search?content_id=10812660&content_type=Article&match_order=1&q=GitHub&zhida_source=entity)已经为我们准备了各种配置文件，只需要组合一下就可以使用了。[https://github.com/github/gitignore](https://link.zhihu.com/?target=https%3A//github.com/github/gitignore)。
