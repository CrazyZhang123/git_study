...
- k,v来自Encoder的输出
- ==Cross attentions是kv来自Encoder,q来自Decoder然后再进行多头注意力机制的过程就是交叉注意力机制==
- 得到的v'就是输出然后进入FC层
...
##### Beam Search 束搜索![image.png](https://gitee.com/zhang-junjie123/picture/raw/master/image/20241110195644.png)
